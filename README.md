...
- Purpose of unsupervised pretraining?: It act as a `initial parametrization` for dnn therefore allowing the model to reach regions considered inaccessible at the first-step.
